...
export interface AccordionProps extends Omit<JSX.HTMLAttributes<HTMLElement>, "onSelect">, BsPrefixProps {
...
declare const _default: BsPrefixRefForwardingComponent<"div", AccordionProps> & {
    Button: BsPrefixRefForwardingComponent<"button", import("./AccordionButton").AccordionButtonProps>;
