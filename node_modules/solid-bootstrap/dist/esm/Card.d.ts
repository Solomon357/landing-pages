...
declare const _default: BsPrefixRefForwardingComponent<"div", CardProps> & {
    ...
    Title: BsPrefixRefForwardingComponent<(p: JSX.HTMLAttributes<HTMLDivElement>) => JSX.Element, unknown>;
    Subtitle: BsPrefixRefForwardingComponent<(p: JSX.HTMLAttributes<HTMLDivElement>) => JSX.Element, unknown>;
