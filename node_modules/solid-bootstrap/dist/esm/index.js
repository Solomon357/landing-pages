...
import { createContext, createMemo, useContext, splitProps, mergeProps, createSignal, children, Show, createComputed, batch, createEffect, onCleanup, createSelector, For, getOwner, runWithOwner } from 'solid-js';
import { resolveClasses, callEventHandler, createControlledProp, Anchor, ModalManager, useButtonProps, useDropdownItem, useDropdownMenu, DropdownContext as DropdownContext$2, useDropdownToggle, Dropdown as Dropdown$2, useNavItem, makeEventKey, Nav as Nav$2, Modal as Modal$2, SelectableContext, Overlay as Overlay$2, OverlayContext, Tabs as Tabs$2, useTabPanel, TabContext } from 'solid-bootstrap-core';
export { Anchor, OverlayContext } from 'solid-bootstrap-core';
...
function isVisible(element) {
  if (!element || !element.style || !element.parentNode ||
  // @ts-ignore
...
const Modal = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$t, p), ["bsPrefix", "class", "style", "dialogClass", "contentClass", "children", "dialogAs", "aria-labelledby", /* BaseModal props */
...
const Offcanvas = p => {
  const [local, props] = splitProps(mergeProps(defaultProps$l, p), ["bsPrefix", "class", "children", "aria-labelledby", "placement", /*BaseModal props */
...
const Overlay = p => {
  const [local, outerProps] = splitProps(mergeProps(defaultProps$i, p), ["children" /*overlay*/, "transition", "ref"]);
...
function createButton(name, defaultValue, label = name) {
  function Button(props) {
    ...
    return createComponent(PageItem, mergeProps$1(rest, {
      get children() {
        return [(() => {
...
const TabPane = p => {
  ...
  const Transition = meta.transition || Fade$1;
