...
declare const _default: BsPrefixRefForwardingComponent<"div", NavDropdownProps> & {
    Item: BsPrefixRefForwardingComponent<(p: import("solid-bootstrap-core").DropdownItemProps<HTMLButtonElement>) => JSX.Element, import("./DropdownItem").DropdownItemProps>;
