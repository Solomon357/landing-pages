...
import { mergeProps, createMemo, splitProps, createContext, $PROXY, $TRACK, getListener, batch, createSignal, on, createEffect, onCleanup, useContext, createComputed, getOwner, onMount, Show, runWithOwner, children } from 'solid-js';
...
const Overlay = props => {
  ...
  const InnerChild = () => runWithOwner(owner, () => createComponent(OverlayContext$1.Provider, {
    value: {
      get wrapperProps() {
        return wrapperProps();
      },
