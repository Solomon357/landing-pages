 ...
 * @returns
 */
export declare function createControlledProp<TProp, THandler extends Handler = Handler>(propValue: () => TProp | undefined, defaultValue: () => TProp | undefined, handler?: THandler): readonly [() => TProp | undefined, THandler];
